...
지금 작성하고 있는 **포스팅**도 에디터에서 마크다운을 사용해 작성하고 있으며, **깃허브 README 파일**에도 마크다운 문법이 사용된다. 


![README](https://user-images.githubusercontent.com/98953394/161323713-602fced6-dfde-4438-a6ab-e70ee34128ed.png "README")

이곳 저곳 다양한 플랫폼에서 쓰이는 만큼, 내가 자주 사용하는 마크다운 문법 위주로 정리해보려고 한다.
...
마크다운 문법에 대해 간략하게 정리해봤다! HTML 문법과 혼용해서 쓸 수 있는 부분이 많은 만큼, 알아두고 편리하게 사용하자. 
