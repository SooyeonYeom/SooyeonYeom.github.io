...
description: 
image: https://user-images.githubusercontent.com/98953394/161267937-6de8202e-7ac1-4735-941e-2ceda9fd89fa.png
optimized_image: https://user-images.githubusercontent.com/98953394/161267937-6de8202e-7ac1-4735-941e-2ceda9fd89fa.png
category: Dev
tags:
  - Programming
author: Freeyeon
...
그리고 우리가 터미널에 입력한 명령어를 해석하고, 명령에 해당하는 답을 터미널에 출력해주는 소프트웨어를 **셸(Shell)**이라고 한다. bash, zsh 이런 것들이다. 그 중 나는 기본값으로 되어있던 bash쉘을 사용하는데.. 아직 자세히 알아볼 필요성을 못느껴서, 자세한 건 나중에 알아보도록 하자. 
...
CLI와 터미널, 셸, 자주 사용하는 명령어에 대해 알아보았다. 추가적으로 정리하고 싶은 명령어가 있다면 계속 업데이트할 예정이다!
<br>
